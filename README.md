...
```sh
cargo test                            # 224 tests, green on Linux/macOS/Windows
...
| `tests/` | 224 tests: conformance (70) + sourcing & dependencies (37) + new kinds (24) + deps vocabulary (21) + config/YAML (19) + single-file (19) + trust (15) + MCP bridge (7) + authoring (5) + `--locked` (5) + capture (2) |
