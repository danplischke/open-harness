...
| `tests/{profile,trust,mcp,mcp_http,authoring}.rs` | Sourcing (11), signing (9), MCP bridge (7: stdio+http), scaffold/matrix (5) |
...
```sh
cargo test                            # 102 tests (conformance + profile + trust + mcp + authoring)
