...
| `tests/` | 349 tests: conformance (76) + sourcing & dependencies (55) + runtimes & provisioning (29) + new kinds (24) + deps vocabulary (21) + selection (21) + plugin import (21) + config/YAML (20) + single-file (19) + trust (15) + JSON→YAML migration (12) + `--locked` (9) + MCP bridge (7) + unit (7) + publishing (6) + authoring (5) + capture (2) |
